...
module.exports = {
    ...
    createorupdateUser: function (name, age_date, height, is_male, phone_number, activity_type_id, training_goals_type_id, cb) {
    ...
    updateTrainingGoal: function (phone_number, training_goals_type_id) {
        return this.User.findOne({where: {phone_number: phone_number}})
            .then(user => {

                if (user) {
                    return this.User.update(
                        {
                            training_goals_type_id: training_goals_type_id
                        },
                        {
                            where: {phone_number: phone_number}
                        }).then( result => {

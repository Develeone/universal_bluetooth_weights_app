...
MiScaleLib
{
...
)
    {
        ...
        if (sex == 0) {
            ...
            if (height < weight * 1.6) {
                ...
                visceralFat = ((weight * 305.0) / (subcalc + 48.0)) - 2.9
                f + (age * 0.15);
            }
            else {
                float
    ...
    function getBodyFat(weight, impedance) {
        ...
        bodyFat = (1.0 - (((lbmCoeff - lbmSub) * coeff) / weight)) *
        100.0;

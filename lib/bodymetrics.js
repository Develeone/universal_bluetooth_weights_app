class MiScaleLib {
    ...
    getLBMCoefficient(weight, impedance) {
...
)
{
    ...
    function getWater(weight,impedance)
    {
        var coeff;
        var water = (100.0 - getBodyFat(weight, impedance)) * 0.7;
    ...
    function getBoneMass(weight, impedance)
    {
        var boneMass;
        var base;
